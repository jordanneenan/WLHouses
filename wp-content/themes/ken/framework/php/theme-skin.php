 ...
 */
	$toolbar_bg = $mk_settings['toolbar-bg']['color'] ? 'background-color:' . $mk_settings['toolbar-bg']['color'] . ';' : '';
	$toolbar_bg .= $mk_settings['toolbar-bg']['url'] ? 'background-image:url(' . $mk_settings['toolbar-bg']['url'] . ');' : ' ';
	$toolbar_bg .= $mk_settings['toolbar-bg']['position'] ? 'background-position:' . $mk_settings['toolbar-bg']['position'] . ';' : '';
	$toolbar_bg .= $mk_settings['toolbar-bg']['attachment'] ? 'background-attachment:' . $mk_settings['toolbar-bg']['attachment'] . ';' : '';
	$toolbar_bg .= $mk_settings['toolbar-bg']['repeat'] ? 'background-repeat:' . $mk_settings['toolbar-bg']['repeat'] . ';' : '';
	$toolbar_bg .= (isset($mk_settings['toolbar-bg']['cover']) && $mk_settings['toolbar-bg']['cover'] == 1) ? 'background-size: cover;background-repeat: no-repeat;-moz-background-size: cover;-webkit-background-size: cover;-o-background-size: cover;' : '';
...
###########################################
	...
	# Header Toolbar
	if($mk_settings['header-toolbar'] == 1){
		$header_height_with_toolbar = $logo_height+($mk_settings['header-padding'] * 2) + 35;
	}else{
		$header_height_with_toolbar = $logo_height+($mk_settings['header-padding'] * 2);
	}
	$toolbar_border = isset($mk_settings['toolbar-border-top']) && ($mk_settings['toolbar-border-top'] == 1) ? '' : 'border:none;';
...
.theme-main-wrapper:not(.vertical-header) .sticky-header.sticky-header-padding {
	padding-top:{$header_height_with_toolbar}px;
}
...
@media handheld, only screen and (min-width:{$mk_settings['res-nav-width']}px) {
...
$header_border_bottom_color = (isset($mk_settings['toolbar-border-bottom-color']) && !empty($mk_settings['toolbar-border-bottom-color'])) ? $mk_settings['toolbar-border-bottom-color'] : 'transparent';
$header_phone_email_icon_color = (isset($mk_settings['toolbar-phone-email-icon-color']) && !empty($mk_settings['toolbar-phone-email-icon-color'])) ? $mk_settings['toolbar-phone-email-icon-color'] : $mk_settings['toolbar-text-color'];
...
$breadcrumb_skin = (isset($mk_settings['breadcrumb-skin']) && !empty($mk_settings['breadcrumb-skin']) && $mk_settings['breadcrumb-skin'] == 'custom' ) ? 1 : 0;
$breadcrumb_custom_color_regular = (isset($mk_settings['breadcrumb-skin-custom']['regular']) && !empty($mk_settings['breadcrumb-skin-custom']['regular']) ) ? $mk_settings['breadcrumb-skin-custom']['regular'] : $custom_breadcrumb_color ;
$breadcrumb_custom_color_hover = (isset($mk_settings['breadcrumb-skin-custom']['hover']) && !empty($mk_settings['breadcrumb-skin-custom']['hover']) ) ? $mk_settings['breadcrumb-skin-custom']['hover'] : $custom_breadcrumb_hover_color ;

if($breadcrumb_skin == 1){

	if($custom_breadcrumb_page == 1){
		
		$output .= " #mk-breadcrumbs .custom-skin{
...
###########################################
function mk_important_dynamic_css(){
	$output = '';
...
add_action('wp_head', 'mk_important_dynamic_css', 9999);
