    ...
    if ( ! class_exists( 'Redux_Framework_sample_config' ) ) {
		...
		'fields' => array(
			...
			array(
				...
				'desc' => __("This option will give you the ability to add any icon you want to use for side dashboard trigger icon. <a target='_blank' href='" . admin_url('tools.php?page=icon-library') . "'>Click here</a> to get the icon class name.", 'mk_framework'),
				'subtitle' => __("", 'mk_framework'),
				'default' => '',
			),
			array(
	...
	$this->sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'desc' => __("This option will give you the ability to add any icon you want to use for front of the phone number. <a target='_blank' href='" . admin_url('tools.php?page=icon-library') . "'>Click here</a> to get the icon class name.", 'mk_framework'),
				'subtitle' => __("", 'mk_framework'),
				'default' => '',
			),
			array(
			...
			array(
				...
				'desc' => __("This option will give you the ability to add any icon you want to use for front of the email address. <a target='_blank' href='" . admin_url('tools.php?page=icon-library') . "'>Click here</a> to get the icon class name.", 'mk_framework'),
				'subtitle' => __("", 'mk_framework'),
				'default' => '',
			),
	...
	$this->sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'info',
				'style' => 'warning',
				'desc' => __("Note: Adobe Typekit is a premium service. <a target='_blank' href='http://artbees.freshdesk.com/support/solutions/articles/1000126904'>Learn More</a>", 'mk_framework'),
				'subtitle' => __("", 'mk_framework'),
				'default' => '',
			),
			array(
	...
	$this->sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'switch',
				'title' => __('Show Toolbar Border Top?', 'mk_framework'),
				'subtitle' => __('', 'mk_framework'),
				'desc' => __('', 'mk_framework'),
				"default" => 1,
				'on' => 'Enable',
