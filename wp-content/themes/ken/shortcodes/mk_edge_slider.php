...
$output .= '<div id="mk-edge-slider-'.$id.'" class="mk-edge-slider mk-swiper-container first-el-' . $first_el . '" style="height:' . $height . 'px;" data-first="' . $first_el . '" data-loop="'.$edge_slider_loop.'" data-hash="'.$edge_slider_hash.'" data-height="' . $height . '" data-fullHeight="' . $full_height . '" data-pause="' . $slideshow_speed . '" data-speed="' . $animation_speed . '"  data-pagination="'.$pagination_class.'" data-animation="'.$animation_effect.'">';
